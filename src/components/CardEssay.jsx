      ...
      {showPopup && (
              <div className="popup">
                ...
                <div className="popup-header">
                  ...
                  <p style={{fontSize:'20px', marginTop:'1rem'}}>Tendrá a su disposición <b>20 minutos</b> para contestar el ensayo de <b>10 preguntas</b>, podrá navegar entre preguntas. </p>
